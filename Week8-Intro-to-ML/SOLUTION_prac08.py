...
'''
Solutions to W08 Prac

    
    Created on 2017-07-29 by f.maire@qut.edu.au
    
    Last modified on 2018-08-04 by f.maire@qut.edu.au
       . Fixed typos
...
def ex4():
    m = 10
    x = np.linspace(-3,3,m)
    t = np.sin(x) + 0.2 *np.random.randn(m) #0.2 is arbitrary
